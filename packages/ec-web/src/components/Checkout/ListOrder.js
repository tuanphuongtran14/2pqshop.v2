  ...
  isCheckCoupon = (coupon, price) => {
    ...
    if (coupon === "quocdeptrai" || coupon === "PhatLC") {
      if (coupon === "quocdeptrai") {
        ...
        this.props.onAddCouponToOrder({ coupon: coupon, salePrice: salePrice });
      ...
      this.setState({
        ...
        salePrice: 0,
        infoCheckout:
          "Mã khuyến mãi của bạn không đúng hoặc đã hết thời hạn!!!",
      });
    }
  };
      ...
      <Fragment>
        <div className="checkout__order">
          ...
          <ul className="checkout__total__all">
            <li>
              Tổng phụ <span>{convertToMoney(this.props.totalPrice)}VND</span>
            </li>
            <li>
              Khuyến mãi <span>{convertToMoney(salePrice)}VND</span>
            </li>
            <li>
              Số tiền phải trả{" "}
              <span>
                {convertToMoney(this.props.totalPrice - salePrice)}VND
              </span>
            </li>
          </ul>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <button
                type="button"
                onClick={() =>
                  this.isCheckCoupon(coupon, this.props.cart.totalAmount)
                }
              >
                Kiểm tra
              </button>
